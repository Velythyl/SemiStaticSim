...
SCENE_NAME_MAP = {
    'Blocks - Yellow On Black On Blue': "Blocks - Make a 'yellow on black on blue' tower",
    ...
    'Pepper In Cooler': "Veggies - Put the bell pepper in the cooler",
    'Slice Veggies And Place In Cooler': "Veggies - Prep the veggies and put in cooler",
    'Blocks - Green On Yellow On Black': "Blocks - Make a 'green on yellow on black' tower"
}
...
def get_hue_palette(df, hue_col="planner/llm_clean"):
    ...
    full_palette = sns.color_palette("colorblind", n_colors=len(hues)+2)
...
def plot_flowchart_lines_success_safety(df):
    ...
    for scene in scenes:
        ...
        # --- Secondary x-axis ---
        initial_color, feedback_color = 'blue', 'orange'
        ...
        safety_ax.set_title("Unsafe", fontsize=12)
