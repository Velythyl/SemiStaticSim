...
def load_conceptgraph(path):
    ...
    for i, grp in enumerate(copy.deepcopy(segments_anno["segGroups"])):
        for to_remove in ["ceiling", "window", "window blinds", "blinds", "wall", "window blinds", "blinds", "water droplet", "wooden sideboard", "carpet", "rug", "floor rug", "floor carpet"]:#, "wooden sideboard"]: #, "door"]:
