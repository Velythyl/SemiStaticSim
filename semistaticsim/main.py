...
from semistaticsim.utils.file_utils import get_tmp_file
...
def main(cfg):
    ...
    from semistaticsim.conceptgraph.conceptgraph_to_hippo import get_hippos
    ...
    from semistaticsim.reconstruction.assetlookup.CLIPLookup import CLIPLookup
    from semistaticsim.reconstruction.assetlookup.TRELLISLookup import TRELLISLookup
    from semistaticsim.reconstruction.composer import SceneComposer
    global HIPPO
    trellis_proc = None
    if HIPPO is None:
