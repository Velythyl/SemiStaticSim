...
from semistaticsim.simulation.ai2thor_metadata_reader import get_object_list_from_controller, get_robot_inventory, \
...
from semistaticsim.simulation.semanticverifllm.llm_semantic_verification import LLM_verify_diff, UnsafeAction, \
    LLM_verify_final_state, _LLMSemanticVerification, UnsafeFinalState, IncorrectTaskDescription, CorrectFinalState
from semistaticsim.simulation.singlefilelog import log_scenedict_to_file
from semistaticsim.simulation.skillsandconditions.conditions import get_slicing_implement_from_inventory, eval_conditions, \
...
from semistaticsim.simulation.spatialutils.motion_planning import AStar
from semistaticsim.utils.file_utils import get_next_file_counter
...
#                print(self.get_object_container_diff())
    ...
    def GoToObject(self, robot, dest_obj, DISABLE_MOVE=False):
        ...
        def dist_to_goal(obj_pos, obj_size):
            from semistaticsim.simulation.spatialutils.proximity_spatial_funcs import bbox_dist
