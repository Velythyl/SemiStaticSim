...
from semistaticsim.simulation.spatialutils.filter_positions import filter_reachable_positions, draw_grid_graph_2d
...
def GoToObject(self, robot, dest_obj):
    ...
    from semistaticsim.simulation.ai2thor_metadata_reader import get_object_position_from_controller
