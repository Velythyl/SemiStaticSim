...
class SkillPortfolio(SelfDataclass):
    ...
    def create(cls, skill_metadata):
        from semistaticsim.simulation.skillsandconditions.skill_names import get_llm_name_2_skill, get_anti_llm_name_2_skill
        ...
        from semistaticsim.simulation.skillsandconditions.skill_names import get_enabledname_2_skills
    ...
    def find_skill(self, sas: SimulationActionState | str):
        import semistaticsim.simulation.skillsandconditions.skills  # noqa
        from semistaticsim.simulation.skillsandconditions.skill_names import find_skillname_2_enabledname
