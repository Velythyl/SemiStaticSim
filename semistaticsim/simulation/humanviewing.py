...
from semistaticsim.simulation.semanticverifllm.llm_semantic_verification import CorrectFinalState
from semistaticsim.simulation.skillsandconditions.conditions import Condlist
from semistaticsim.reconstruction.scenedata import HippoObject, dict2xyztuple
...
class HumanViewing:
    ...
    def get_augmented_robot_frame(self, frame, message=None, held_item=None, hud_scale=2):
        ...
        for line in message_lines:
            cv2.putText(hud_frame, line,
                        (msg_box_tl[0] + inner_pad, line_y),
                        font, base_font_scale, (255, 255, 255), thickness, cv2.LINE_AA)
            line_y += int(20 * hud_scale)
